  ...
  return (
    <section className="py-8 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800 transition-colors duration-300">
      <div className="px-4 mb-4">
        <h2 className="text-xl font-bold text-slate-800 dark:text-white">Wajib Dicicipi 🍜</h2>
        <p className="text-slate-500 dark:text-slate-400 text-sm">Kuliner legendaris khas daerah</p>
      </div>
